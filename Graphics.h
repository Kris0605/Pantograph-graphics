...
private:
	...
	Shaders::Phong _texturedShader{Shaders::Phong::Flag::AmbientTexture | Shaders::Phong::Flag::DiffuseTexture };
	Containers::Array<Containers::Optional<GL::Mesh>> _meshes;
	Containers::Array<Containers::Optional<GL::Texture2D>> _textures;

	Scene3D _scene;
	Object3D _manipulator, _cameraObject, _endEffector, _ball, _spinner, _opponent;
	...
	Vector2 _previousOpponentPosition;
	float _previousSpinnerAlpha;
	float _previousSpinnerScale;
	float _spinnerScale;
	float _spinnerZtranslate;
	float _previousSpinnerZtranslate;
